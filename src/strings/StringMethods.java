...
public class StringMethods {
	...
	public static void main(String[] args) {
	  ...
	  //Concatenates st2 with st1.
	    System.out.println(" concatination st1 and st2 is:"+st1.concat(st2));
	  //Retrieve the 9th Indexed character from string.
	    System.out.println("character at 9th index is:"+st1.charAt(9));
	  //Find the length of string.
	    System.out.println("Length of Strin is:"+st1.length());	 
	  //Converting whole string In lower case.
	    ...
	    System.out.println("String In Lowercase ->"+st1.toUpperCase());
